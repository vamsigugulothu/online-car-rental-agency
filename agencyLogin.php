  ...
  <body>
    ...
    <div class="d-flex flex-wrap justify-content-around align-items-center">
      ...
      <div class="border login_grid" style="background-color:#fff; width: 400px; height: 470px; margin-top: 100px">
        <div class="p-4">
          <h4 class="text-center mb-4 mt-2">Agency Login</h4>
            <?php 
          ...
          <form method="post" action="agencyBackend.php" onsubmit="!validate() ? event.preventDefault():''" name="form" autocomplete="off">
            <!-- email -->
              ...
              <a href="forgetPasswordAgency.php">Forget Password?</a>
          ...
          <p class="text-center">Are you a customer? <a href="customerLogin.php">Login Here</a>
        </div>
      </div>
    </div>
